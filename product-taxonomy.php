        ...
        <div id="shopCrateCanvas" class="row">
            <div id="filterColumn" class="col-md-3">
                ...
                /* ------------------------------ +/
                  SIDEBAR WIDGET:
                  /+ ------------------------------ */
				  dynamic_sidebar('shop_left_cat');
                ?>
                <?php //echo do_shortcode( '[searchandfilter fields="search,product_cat,product_tag" order_dir=",asc,desc" order_by=",id,name" types=",checkbox,checkbox" headings=",Categories,Tags" ]' ); ?>
                <?php //echo do_shortcode( '[searchandfilter fields="product_cat,product_tag" types="checkbox,checkbox" headings="Categories,Tags" submit_label="Filter" operators="or,or" add_search_param="1"]' ); ?>
                
                <?php /*?><div class="shopFilterWidget">
                    <h3>Canvas Type</h3>
            ...
            <div id="productColumn" class="col-md-9">
                ...
                /* ------------------------------ +/
                  SORTING BAR:
                  /+ ------------------------------ */
				  // dynamic_sidebar('price_filter_sidebar');
                ?>
                ...
                $products_list_html = ob_get_clean(); //print_r($products_list_html);
