...
?>
  ...
  <div class="col-md-4"><strong><?php _e('Shipping', 'jigoshop'); ?></strong> <br> <?php echo _x('To: ', 'shipping destination', 'jigoshop').__(jigoshop_customer::get_shipping_country_or_state(), 'jigoshop'); ?></div><!-- / -->
  <div class="col-md-8">
