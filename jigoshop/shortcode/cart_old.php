    ...
    <div class="row">
      ...
      <div class="row" id="cartItem">
        <div class="col-md-6" id="cartItemLeft">
          ...
          <div class="row">
            ...
            <div class="col-md-8" id="">
            <a href="#">34 x 56 Bishop's Prayer Single Canvas Print</a>
            </div><!-- / -->
          </div><!-- / -->
          ...
          <div class="row">
            ...
            <div class="col-md-4" id="">
                <div class="input-group">
                  <span class="input-group-addon"><button type="button" class="minus no-btn" id="minus1">-</button></span>
                  <input type="text" class="form-control"  value="1">
                   <span class="input-group-addon"><button type="button" class="plus no-btn" id="add1">+</button></span>
                </div>
            </div><!-- / -->
            <div class="col-md-4" id="">
            $2,000
      ...
      <div class="row" id="cartTotal">
        ...
        <div class="row">
          ...
          <div class="col-md-7">$2,148.75 <br/> (ex.tax)</div><!-- / -->
        </div><!-- / -->
        
        <div class="row">
          <div class="col-md-5"><strong>Shipping</strong> <br/> To: Philadelphia</div><!-- / -->
          <div class="col-md-7">FREE <br/> via Flat Rate</div><!-- / -->
        </div><!-- / -->
        
        <div class="row">
          <div class="col-md-5"><strong>Tax</strong> (0%) <br/> Estimated For: <br/> United States</div><!-- / -->
          <div class="col-md-7">$0.000</div><!-- / -->
        </div><!-- / -->
        
        <div class="row">
          <div class="col-md-5"><strong>Total</strong></div><!-- / -->
          <div class="col-md-7">$2,148.75</div><!-- / -->
        </div><!-- / -->
