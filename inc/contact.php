      ...
      <div class="col-sm-4">
        ...
        <div class="form-wrapper clearfix">
          <form class="form-contact email-form">
            ...
            <div class="form-success"> <span class="text-white">Message sent - Thanks for your enquiry</span> </div>
            <div class="form-error"> <span class="text-white">Please complete all fields correctly</span> </div>
          </form>
        </div>
      </div>
    </div>
